import { FormGroup, FormControl, FormLabel, FormSelect, Form, InputGroup, Row, Col, Button } from "react-bootstrap";
        ...
        <div>
            ...
            <div id="wd-css-responsive-forms-1">
                ...
                <Form.Group as={Row} className="mb-3" controlId="email1">
                    ...
                    <Col sm={10}>
                    <Form.Control type="email" defaultValue="email@example.com" placeholder="email@example.com"/>
                    </Col>
                </Form.Group>
