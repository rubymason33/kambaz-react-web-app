...
export default function TOC() {
    ...
    return (
        <Nav variant="pills" id="wd-toc">
            ...
            <Nav.Item> <Nav.Link href="https://kambaz-node-server-app-8a3n.onrender.com" target="_blank" active={pathname.includes("render")}>Ruby's Render Server (a5)</Nav.Link> </Nav.Item>
            <Nav.Item> <Nav.Link href="https://kambaz-node-server-app-1-rrtx.onrender.com" target="_blank" active={pathname.includes("render")}>Ruby's Render Server (a6)</Nav.Link> </Nav.Item>
        </Nav>
    );
}
