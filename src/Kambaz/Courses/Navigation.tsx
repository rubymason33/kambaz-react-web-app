...
export default function CourseNavigation() {
    ...
    return (
        <div id="wd-courses-navigation" className="wd list-group fs-5 rounded-0">
            ...
            className={"list-group-item border border-0 " + (location === "/Kambaz/Courses/1234/Home" ? "active" : "text-danger")}> Home </Link>
            <Link to="/Kambaz/Courses/1234/Modules" id="wd-course-modules-link"
            className={"list-group-item border border-0 " + (location === "/Kambaz/Courses/1234/Modules" ? "active" : "text-danger")}> Modules </Link>
            <Link to="/Kambaz/Courses/1234/Piazza" id="wd-course-piazza-link"
            className={"list-group-item border border-0 " + (location === "/Kambaz/Courses/1234/Piazza" ? "active" : "text-danger")}> Piazza </Link>
            <Link to="/Kambaz/Courses/1234/Zoom" id="wd-course-zoom-link"
            className={"list-group-item border border-0 " + (location === "/Kambaz/Courses/1234/Zoom" ? "active" : "text-danger")}> Zoom </Link>
